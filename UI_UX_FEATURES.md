...
- [x] JS eval tool. Read DOM, computed styles, box model, runtime text.
- [x] JS/CSS injection. Prototype tweaks in-page, no rebuild.
- [x] Style capture. Bundle computed styles or inline critical CSS.
- [x] Asset snapshot. Save HTML plus linked CSS/JS/assets for offline review.
